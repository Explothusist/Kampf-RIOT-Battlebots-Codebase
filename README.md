# Kampf-RIOT-Battlebots-Codebase

Codebase for battlebots controlled by the Kampf library built on the Automat robot control library, for the Robo RIOT competition.
...
Kampf Library: https://github.com/Explothusist/Kampf-RIOT-Battlebots-Library
